    ...
    <nav className="sticky top-0 z-50 bg-[#07090F]/80 backdrop-blur-xl border-b border-white/10 px-6 py-4 flex items-center justify-between">
      <Link to="/home" className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="font-bold text-sm tracking-widest text-white leading-tight">SMART RAIL</span>
          <span className="text-[9px] text-gray-500 tracking-[0.2em]">MUMBAI METRO</span>
        </div>
      </Link>
